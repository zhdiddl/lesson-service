...
public enum ExceptionCode {
    ...
    USER_DELETED(HttpStatus.NOT_FOUND, "요청한 사용자 계정은 이미 삭제되었습니다."),
    ...
    CART_NOT_FOUND(HttpStatus.NOT_FOUND, "요청한 사용자의 장바구니를 조회할 수 없습니다."),
    ...
    UPDATE_FAIL_DUE_TO_INVALID_INPUT(HttpStatus.BAD_REQUEST, "입력한 값이 유효하지 않아 변경 작업이 실패했습니다."),
